...
public class SearchHitProtoUtils {
    ...
    public static org.opensearch.protobufs.Hit toInnerProto(SearchHit hit) throws IOException {
        ...
        ObjectMap.Builder structBuilder = ObjectMap.newBuilder();
        for (DocumentField field : hit.getMetaFields().values()) {
            ...
            structBuilder.putFields(field.getName(), ObjectMapProtoUtils.toProto(field.getValues()));
        }
        hitBuilder.setMetaFields(structBuilder.build());
