...
public class ExceptionProtoUtilsTests extends OpenSearchTestCase {
    ...
    public void testToProtoWithOpenSearchException() throws IOException {
        ...
        ErrorCause errorCause = ExceptionProtoUtils.toProto(exception);
    ...
    public void testGenerateThrowableProtoWithOpenSearchException() throws IOException {
        ...
        // Convert to Protocol Buffer
        ErrorCause errorCause = ExceptionProtoUtils.generateThrowableProto(exception);
