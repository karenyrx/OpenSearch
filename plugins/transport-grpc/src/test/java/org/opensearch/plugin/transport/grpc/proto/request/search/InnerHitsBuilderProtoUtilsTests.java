...
public class InnerHitsBuilderProtoUtilsTests extends OpenSearchTestCase {
    ...
    // TODO: Add tests for sorts, highlights, and collapse once they are implemented
    /*
    public void testFromProtoWithSorts() throws IOException {
        // Create a protobuf InnerHits with sorts
        InnerHits innerHits = InnerHits.newBuilder()
            .setName("test_inner_hits")
            // Add sort combinations here
            .build();
    ...
    public void testFromProtoWithCollapse() throws IOException {
        ...
        // Verify the result
        assertNotNull("InnerHitBuilder should not be null", innerHitBuilder);
        assertNotNull("InnerCollapse should not be null", innerHitBuilder.getInnerCollapse());
        // Add assertions for collapse
    }
    */
}
