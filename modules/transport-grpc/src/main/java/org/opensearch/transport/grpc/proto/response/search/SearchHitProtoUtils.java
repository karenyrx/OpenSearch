...
public class SearchHitProtoUtils {
     ...
     * @throws IOException if there's an error during conversion
     */
    private static void processExplanation(SearchHit hit, org.opensearch.protobufs.HitsMetadataHitsInner.Builder hitBuilder) throws IOException {
     ...
     * @throws IOException if there's an error during conversion
     */
    private static void processInnerHits(SearchHit hit, org.opensearch.protobufs.HitsMetadataHitsInner.Builder hitBuilder) throws IOException {
